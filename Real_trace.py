    ...
    def __init__(self,job_id,time,machines,tag):
        ...
        if tag == 'CV':
            ...
            if id == 1: # VGG16 on Cifar10 (E*100,B*100)
                self.E = 2
                self.B = 4
                self.D = random.randint(1,machines)
                temp = [0.008701996/self.D, 0.0101606/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'VGG16'
            elif id == 2: # ResNet50 on Cifar100 (E*100,B*100)
                self.E = 2
                self.B = 4
                self.D = random.randint(1,machines)
                temp = [0.072398903/self.D, 0.115064228/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'ResNet50'
                ...
                self.B = 15
                self.D = random.randint(1,machines)
                temp = [0.11686496/self.D, 0.1442247/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'Inception'
        # generate NLP jobs
            ...
            if id == 1:
                ...
                self.B = 3
                self.D = random.randint(1,machines)
                temp = [0.098137448/self.D, 0.142886722/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'LSTM'
                ...
                self.B = 5
                self.D = random.randint(1,machines)
                temp = [0.051147397/self.D, 0.114481531/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
        ...
        # generate Rec. jobs
            ...
            if id == 1: # GraphSAGE on Cora (E*10,B*10)
                ...
                self.B = 2
                self.D = random.randint(1,machines)
                temp = [0.007415931/self.D, 0.0113888/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'GraphSAGE'
                ...
                self.B = 5
                self.D = random.randint(1,machines)
                temp = [0.002505484/self.D, 0.004263958/self.D]
                self.t_c = [temp[random.randint(0,1)] for j in range (machines)]
                self.t_s = [0.005 for i in range (machines)]
                self.type = 'FastGCN'
        ###########################################################
